...
| **P4** | Merge single & cron scrapers (8 phases) | F7 | All scraper files + `VesselTrackingService.php` | **IN PROGRESS** — Phase 1 (LCIT) DONE (session 10), Phase 7 (JWD cron) DONE (session 7), Phase 8 (Everbuild cleanup) DONE (session 9), phases 2-6 TODO |
