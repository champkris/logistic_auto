...
use App\Jobs\ScrapeLCB1Vessel;
use App\Models\Shipment;
use Illuminate\Console\Command;

class ScrapeLCB1Vessels extends Command
{
    protected $signature = 'vessel:scrape-lcb1 {--dry-run}';

    protected $description = 'Dispatch queue jobs to scrape LCB1 vessel schedules';
    ...
    public function handle(): int
    {
        ...
        foreach ($uniqueVessels as $shipment) {
            ...
            if ($dryRun) {
                ...
                ScrapeLCB1Vessel::dispatch($vesselName, $voyage, $portTerminal)
                    ->onQueue('lcb1-scraper');
        ...
        $this->info("{$action} {$dispatched} LCB1 scrape jobs.");
