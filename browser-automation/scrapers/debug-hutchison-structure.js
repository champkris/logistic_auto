...
/**
 * Debug script to inspect Hutchison table structure
 */
async function main() {
  ...
  console.log('🔍 Loading Hutchison schedule page...');
  await page.goto('https://online.hutchisonports.co.th/hptpcs/f?p=114:17', {
