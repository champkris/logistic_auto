...
/**
 * Debug script to inspect TIPS table structure
 */
async function main() {
  const browser = await puppeteer.launch({
    headless: false,  // Show browser to see the page
  ...
  console.log('🔍 Loading TIPS page...');
  await page.goto('https://www.tips.co.th/container/shipSched/List', {
